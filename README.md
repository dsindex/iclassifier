...
|                      | Accuracy (%) | GPU / CPU           | ONNX     | Dynamic   | QAT        | Inference   | Inference+Dynamic | Inference+QAT  | Inference+ONNX           | Etc            |
| -------------------- | ------------ | ------------------- | -------- |---------- | ---------- | ----------- | ----------------- | -------------- | ------------------------ | -------------- |    
...
| DistilBERT, CLS      | 97.71        | 9.3075  / -         | 32.4263  | 33.1947   |  -         | 12.7506     | 10.7088           | -              | 8.3032  / 4.3144         | threads=14     |
...
* QAT(Quantization Aware Training) : --enable_qat
