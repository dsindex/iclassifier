...
- how to
```
$ python preprocess.py --config=configs/config-distilbert-cls.json --bert_model_name_or_path=./embeddings/distilbert-base-uncased --bert_do_lower_case

$ python fastformers.py --teacher_bert_model_name_or_path=./embeddings/bert-base-uncased --state_loss_ratio=0.1  --config=configs/config-distilbert-cls.json --bert_model_name_or_path=./embeddings/distilbert-base-uncased --bert_do_lower_case --bert_output_dir=bert-checkpoint --lr=5e-5 --epoch=3 --batch_size=64
